<?php
namespace LEIAUTENFEV310\TNFe\InfNFe\Det\Imposto\ICMS\ICMSSN201;
...
2 – Estrangeira – Adquirida no mercado interno. (v2.0)  */
            protected $orig;
	            /** @var \LEIAUTENFEV310\TNFe\InfNFe\Det\Imposto\ICMS\ICMSSN201\CSOSN 201- Tributada pelo Simples Nacional com permissão de crédito e com cobrança do ICMS por Substituição Tributária (v.2.0)  */
            protected $CSOSN;
	            /** @var \LEIAUTENFEV310\TNFe\InfNFe\Det\Imposto\ICMS\ICMSSN201\ModBCST Modalidade de determinação da BC do ICMS ST:
...
5 - Pauta (valor). (v2.0)  */
	...
	public function setCSOSN(\LEIAUTENFEV310\TNFe\InfNFe\Det\Imposto\ICMS\ICMSSN201\CSOSN $CSOSN) {
        $this->CSOSN = $CSOSN;
    }
	public function getModBCST() {
        return $this->modBCST;
    }
	public function setModBCST(\LEIAUTENFEV310\TNFe\InfNFe\Det\Imposto\ICMS\ICMSSN201\ModBCST $modBCST) {
